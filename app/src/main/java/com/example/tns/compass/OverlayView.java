...
public class OverlayView extends View {
	 ...
	 */
	private static final DecimalFormat degreeFormat = new DecimalFormat("#0");

	/**
	 * for formatting orthographic scale
	 */
	private static final DecimalFormat scaleFormat = new DecimalFormat("##0");
...
//		}
		...
		if (mPerspectiveProjection) {
			mFOVView.setText(degreeFormat.format(mDerivedDeviceOrientation[0]) + " d");
					} 
		else {
			mFOVView.setText(degreeFormat.format(mDerivedDeviceOrientation[0]) + " d");
		}
