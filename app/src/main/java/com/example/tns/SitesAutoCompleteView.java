...
import android.widget.AutoCompleteTextView;
 ...
 public class SitesAutoCompleteView extends AutoCompleteTextView {
    private String previous = "";
    private String seperator = ";";
     public SitesAutoCompleteView(final Context context, final AttributeSet attrs, final int defStyle) {
         super(context, attrs, defStyle);
         this.setThreshold(0);
     }
    public SitesAutoCompleteView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        this.setThreshold(0);
     }
    public SitesAutoCompleteView(final Context context) {
         super(context);
        this.setThreshold(0);
    }
     /**
